...
\begin{itemize}
    \item \fest{Diese Geschäftsordnung ist nicht Bestandteil der Satzung. Beschlüsse über die Änderungen der Geschäftsordnung gelten ab dem auf die Beschlussfassung folgenden Tag.}
    \item \fest{Die Geschäftsordnung gilt für die Mitgliederversammlung des Plan b Chor Bonn e.V. Sie ist entsprechend auf andere Organe des Plan b Chor Bonn e.V. anzuwenden, soweit diese keine eigene Geschäftsordnung haben.}
\end{itemize}
...
\begin{itemize}
    \item \normal{Vor Eintritt der Tagesordnung sind zunächst folgende Angelegenheiten in nachstehender Reihenfolge festzulegen:}
    \begin{itemize}
        \item Feststellung der Beschlussfähigkeit
        \item Festsetzung der endgültigen Tagesordnung
...
\begin{itemize}
    ...
    \item \fest{Die Öffentlichkeit kann durch einfache Mehrheit herbeigeführt werden.}
